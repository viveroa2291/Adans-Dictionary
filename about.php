...
<body>
    ...
    <section class="about-section">
        <h2>Your brand new home for a Dictionary</h2>
        <h5>New terms and new categories to distinguish them.</h5>
        <div class="about-image">
            ...
            <div class="about-me">
                <article id="about-me">
                    <h2 id="adan">About Me (The Creator)</h2>
                    <hr>
        ...
        <div class="about-paragraph">
            <article id="about">
                ...
                <hr>
                <p>&nbsp;&nbsp;&nbsp;&nbsp; This page was created by me <a href="#adan">(Adan Vivero)</a> as a way of adding definitions to words I did not know. Everyday I would encounter words that I did not know the meaning or definition to and decided to make a website, something I enjoy doing and write down the definitions to the words.</p>
